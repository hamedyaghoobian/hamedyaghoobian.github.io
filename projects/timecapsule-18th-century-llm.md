...
<figure style="text-align:center; margin: 2em 0;">
  ...
  <figcaption style="margin-top:0.75em; font-size:0.9em; color:#666;"><strong>Figure 1.</strong> The epistemological event horizon. Training data terminates at 1875, placing post-Victorian technologies (<em>airplane, electronic computer, internet</em>) in <em>terra incognita</em> — forcing the model to generate Victorian analogical explanations instead.</figcaption>
</figure>
